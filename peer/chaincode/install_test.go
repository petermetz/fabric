...
func TestNonExistentCC(t *testing.T) {
	...
	args := []string{"-n", "badexample02", "-p", "github.com/petermetz/fabric/examples/chaincode/go/bad_example02", "-v", "testversion"}
	cmd.SetArgs(args)
...
func installEx02(t *testing.T) error {
	...
	args := []string{"-n", "example02", "-p", "github.com/petermetz/fabric/examples/chaincode/go/example02/cmd", "-v", "anotherversion"}
	cmd.SetArgs(args)
